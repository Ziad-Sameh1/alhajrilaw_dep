...
import { GetStaff, Delete, DeleteAll, GetStaffByName } from "./StaffMethods";
      ...
      <div className="crud-div">
        <div className="crud-search-div">
          ...
          <Tooltip title={t("refresh")}>
            <IconButton
              onClick={() => {
                props.searchSetter("");
                GetStaff(props.entitySetter, props.size, props.num, t);
              }}
            >
        ...
        <div className="crud-info-list">
          <div className="crud-info-item-header">
            <div className="crud-info-item-attr" style={{ width: "19%" }}>
              {t("profile-pic")}
            </div>
            <div className="crud-info-item-attr" style={{ width: "19%" }}>
              {t("full-name")}
                  ...
                  arr.push(
                    ...
                    >
                      <div className="crud-info-item">
                        ...
                        >
                          <img
                            src={`${process.env.REACT_APP_SERVER}/${props.entity[i].imgLink}`}
                            alt="profile-pic"
                            className="profile-pic-crud"
                          />
                        </div>
                        <div
                          className="crud-info-item-attr"
