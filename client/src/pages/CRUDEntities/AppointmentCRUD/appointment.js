...
import AppointmentUpdateDialog from "./AppointmentUpdateDialog";
        ...
        <div className="crud-search-div">
          ...
          <Tooltip title={t("refresh")}>
            <IconButton
              onClick={() => {
                props.searchSetter("");
                GetAppointments(props.entitySetter, props.size, props.num, t);
              }}
            >
