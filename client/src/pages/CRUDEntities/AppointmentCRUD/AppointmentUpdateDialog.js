...
import { AddAppointments, UpdateAppointments } from "./AppointmentMethods";
const AppointmentUpdateDialog = (props) => {
  const {
    open,
    setOpen,
    data,
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    isAdd
      ...
      : await UpdateAppointments(values, entitySetter, size, num, t);
    setSubmitting(false);
    resetForm();
    setOpen(false);
  };
