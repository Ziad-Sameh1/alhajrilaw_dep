...
import { get, dlt, getByEmail } from "./AdminMethods";
      ...
      <div className="crud-div">
        <div className="crud-search-div">
          ...
          <Tooltip title={t("refresh")}>
            <IconButton
              onClick={() => {
                props.searchSetter("");
                get(props.entitySetter, props.size, props.num, t);
              }}
            >
        ...
        <div className="crud-info-list">
          <div className="crud-info-item-header">
            ...
            <div className="crud-info-item-attr">{t("authority")}</div>
