...
import { GetFAQs, Delete, DeleteAll, GetFAQsByName } from "./FAQMethods";
        ...
        <div className="crud-search-div">
          ...
          <Tooltip title={t("refresh")}>
            <IconButton
              onClick={() => {
                props.searchSetter("");
                GetFAQs(props.entitySetter, props.size, props.num, t);
              }}
            >
